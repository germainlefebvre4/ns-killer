    ...
    if ns_name not in cfg['namespace']['exclude']:
        ...
        if cfg['config']['retention']['kind'] == "minutes":
            ...
            if ns_creation_ago_hours >= cfg['config']['retention']['time']:
                print("{} | Killed namespace '{}' that lived for {} minutes".format(date_now, ns_name, ns_creation_ago_hours))
        elif cfg['config']['retention']['kind'] == "hours":
            ns_creation_ago_hours = divmod(ns_creation_ago.days * 86400 + ns_creation_ago.seconds, 60*60)[0]
            if ns_creation_ago_hours >= cfg['config']['retention']['time']:
            ...
            ns_creation_ago_hours = divmod(ns_creation_ago.days * 86400 + ns_creation_ago.seconds, 60*60*24)[0]
            if ns_creation_ago_hours >= cfg['config']['retention']['time']:
            ...
            ns_creation_ago_hours = divmod(ns_creation_ago.days * 86400 + ns_creation_ago.seconds, 60*60*24*7)[0]
            if ns_creation_ago_hours >= cfg['config']['retention']['time']:
            ...
            ns_creation_ago_hours = divmod(ns_creation_ago.days * 86400 + ns_creation_ago.seconds, 60*60*24*30)[0]
            if ns_creation_ago_hours >= cfg['config']['retention']['time']:
